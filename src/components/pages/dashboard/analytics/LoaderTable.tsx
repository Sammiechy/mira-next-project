...
import { GET_ALL_LOADS, GET_DRIVERS, SEARCH_DRIVERS } from "@/hooks/queries/queries";
...
const LoaderTable = () => {
  ...
  const { loading, error, data, refetch } = useQuery(GET_ALL_LOADS, {
