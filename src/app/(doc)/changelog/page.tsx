        ...
        >
          ...
          <Box mt={3}>
            <Typography variant="subtitle1">
              <Chip color="secondary" label="v5.0.1" /> – Oct 18, 2024
              <ul>
                <li>Upgrade to Node v20.18.0</li>
                <li>Upgrade to MUI v6.1.4</li>
                <li>Upgrade to MUI Data Grid v7.21.0</li>
                <li>Upgrade to MUI Date Pickers v7.21.0</li>
              </ul>
            </Typography>
            <Divider my={6} />

            <Typography variant="subtitle1">
              <Chip color="secondary" label="v5.0.0" /> – Sept 23, 2024
              <ul>
                <li>Migrate to Next.js App Router</li>
                <li>Migrate to Grid v2</li>
                <li>Replace react-beautiful-dnd with @hello-pangea/dnd</li>
                <li>Update fonts in Figma file</li>
                <li>Improve documentation</li>
                <li>Upgrade to Node v20.17.0</li>
                <li>Upgrade to Vite v5.2.11</li>
                <li>Upgrade to Next.js v14.2.13</li>
                <li>Upgrade to MUI v6.1.1</li>
                <li>Upgrade to MUI Data Grid v7.18.0</li>
                <li>Upgrade to MUI Date Pickers v7.18.0</li>
