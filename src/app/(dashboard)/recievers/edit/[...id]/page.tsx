...
import { GET_RECIEVER_BY_ID, GET_SHIPPER_BY_ID } from "@/hooks/queries/queries";
import { EDIT_RECIEVER, EDIT_SHIPPER } from "@/hooks/mutations/mutation";
...
const [editReciever, {  loading, error }] = useMutation(EDIT_RECIEVER);
